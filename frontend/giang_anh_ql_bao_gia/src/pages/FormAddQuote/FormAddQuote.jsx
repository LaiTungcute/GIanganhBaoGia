        ...
        <div className={cx('wrapper')}>
            ...
            >
                <div className={cx('form')}>
                    <div>
                        <Form.Item label="Tên báo giá" name="quantionName" rules={
                            [
                                {
                                    required: true,
                        ...
                        <Form.Item label="Người báo giá" name="username" rules={
                            [
                                {
                                    required: true,
                        ...
                        <Form.Item label="Tên sản phẩm" name="productName" rules={
                            [{
                                required: true,
                        ...
                        <Form.Item label="Đơn vị sản phẩm" name="unit" rules={
                            [
                                {
                                    required: true,
                        ...
                        <Form.Item label="Bộ phận" name="roles" rules={
                            [
                                {
                                    required: true,
                    ...
                    <div>
                        <Form.Item label="Số khách hàng" name="customerPhoneNumber" rules={
                            [
                                {
                                    required: true,
                        ...
                        <Form.Item label="Số lượng" name="quantionItemQty" rules={
                            [
                                {
                                    required: true,
                        ...
                        <Form.Item label="Địa chỉ" name="customerAddress" rules={
                            [
                                {
                                    required: true,
                        ...
                        <Form.Item label="Đơn vị" name="customerUnit" rules={
                            [
                                {
                                    required: true,
                        ...
                        <Form.Item label="Khách hàng" name="customerName" rules={
                            [
                                {
                                    required: true,
                        ...
                        <Form.Item label="Email khách hàng" name="customerEmail" rules={
                            [
                                {
                                    required: true,
                        ...
                        <Form.Item label="Tiền nhân công" name="quantionItemLabol" rules={
                            [
                                {
                                    required: true,
                                    message: 'Vui lòng nhập tiền nhân công'
                                }
                            ]
                        }>
                            <Input />
